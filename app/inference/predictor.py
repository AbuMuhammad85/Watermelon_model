...
def predict_crop_and_disease(
    ...
    if det_pred < detector_threshold:
        res = {
            ...
            "raw_detector_output": float(det_pred),
            "watermelon_probability": float(det_pred),
            "not_watermelon_probability": float(1.0 - det_pred),
            "detector_threshold": float(detector_threshold),
            "disease_threshold": float(disease_threshold),
            "detector_decision": "NOT WATERMELON",
            "disease": None,
